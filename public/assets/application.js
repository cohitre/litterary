...
(function() {
  ...
  angular.module("Litterary").controller("NotesController", [
    "$q", "NotesService", function($q, NotesService) {
      return {
        getNote: function(noteId) {
          var _this = this;
          if (this.note) {
            return $q.resolve(this.note);
          } else {
...
(function() {
  ...
  angular.module("Litterary").directive("highlightable", [
    "$compile", function($compile) {
      return function(scope, element) {
        var stb;
        stb = new SelectableTextBlock(element);
        stb.select(function(range) {
        ...
        scope.refresh = function() {
          if (scope.noteString != null) {
            return element.html(scope.noteString.toHtml());
          }
        };
        scope.addClass = function(start, end, klass) {
          return scope.noteString.range(start, end).addClass(klass);
        };
...
(function() {
  ...
  angular.module("Litterary").directive("rangeCommentForm", [
    "NoteCitationsService", function(NoteCitationsService) {
      return {
        link: function(scope, el) {
          scope.submitComment = function() {
            NoteCitationsService.create(scope.note.id, scope.citation).then(function(result) {
              return scope.highlight(result);
            });
    ...
    "NotesService", "$compile", "$sce", function(NotesService, $compile, $sce) {
      return {
        ...
        link: function(scope, element, attributes, controller) {
          ...
          controller.getNote(noteId).then(function(note) {
            ...
            for (_i = 0, _len = _ref.length; _i < _len; _i++) {
              citation = _ref[_i];
              _results.push(scope.highlight(citation.range.start, citation.range.end));
            }
            return _results;
          });
          ...
          selectableBlock.select(function(range) {
            return scope.$apply(function() {
              return scope.highlight(range.start, range.end);
            });
          });
          scope.note = null;
          scope.noteString = null;
          scope.isCommentable = function() {
            return scope.citation === void 0;
          };
          scope.clearCitation = function() {
            return scope.citation = void 0;
          };
          scope.getDocumentHtml = function() {
            if (scope.noteString != null) {
              return $sce.trustAsHtml(scope.noteString.toHtml());
            } else {
          ...
          scope.highlight = function(start, end) {
            ...
            return scope.noteString.range(start, end).addClass("highlight");
          };
          return scope.getQueryRangeCommentArea = function(st, end) {
            scope.citation = {
              comment: "",
              range: {
                start: st,
            ...
            return element.find("[range-comment-form]");
          };
        }
      };
    }
...
(function() {
  ...
  angular.module("Litterary").service("NoteCitationsService", [
    "$http", function($http) {
      return {
        index: function(noteId) {
          return $http.get("/api/v1/notes/" + noteId + "/citations").then(function(res) {
            return res.data;
          });
        },
        create: function(noteId, model) {
          var d;
          d = {
            citation: model
          };
